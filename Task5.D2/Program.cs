...
В третьей строке нужно вывести «YES»,
    если Вася может рассчитывать на четверку и «NO» в противном случае.     // если четных больше выводим или равно нечетным выводим «YES»
...
Console.WriteLine($"\n[{string.Join("\t", array)}]");                                   // Вывод ответа по форме задания
